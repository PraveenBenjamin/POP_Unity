...
/// <summary>
/// Intended to be a script that performs transitions of properties in specific components
/// ran out of time before it could be fleshed out. So now it only does transitions of vector3 properties.
/// </summary>
